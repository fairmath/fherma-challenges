...
FraudDetect::FraudDetect(std::string ccLocation, std::string pubKeyLocation, std::string multKeyLocation,
...
void FraudDetect::eval()
{
    
}

void FraudDetect::serializeOutput()
{
