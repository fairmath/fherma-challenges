...
$\tilde{p}_{\mathrm{even}}^{\{3,4,5,6\}}(x) = \tilde{p}_{\mathrm{even}}^{\{3,4\}}(x) \tilde{p}_{\mathrm{even}}^{\{5,6\}}(x),$

$\tilde{p}_{\mathrm{even}}(x) = \tilde{p}_{\mathrm{even}}^{\{1,2\}}(x) \, \tilde{p}_{\mathrm{even}}^{\{3,4,5,6\}}(x).$
</p>
